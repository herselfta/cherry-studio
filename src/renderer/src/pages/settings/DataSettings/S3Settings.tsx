...
const S3Settings: FC = () => {
	...
	const [secretAccessKey, setSecretAccessKey] = useState<string | undefined>(
		s3SecretAccessKeyInit,
	);
	const [root, setRoot] = useState<string | undefined>(s3RootInit);
	const [skipBackupFile, setSkipBackupFile] =
		useState<boolean>(s3SkipBackupFileInit);
	...
	return (
		<SettingGroup theme={theme}>
			...
			<SettingRow>
				<SettingRowTitle>
					{t("settings.data.s3.endpoint.label")}
				</SettingRowTitle>
				<Input
			...
			<SettingRow>
				<SettingRowTitle>
					{t("settings.data.s3.accessKeyId.label")}
				</SettingRowTitle>
				<Input
					...
					style={{ width: 250 }}
					onBlur={() =>
						dispatch(setS3Partial({ accessKeyId: accessKeyId || "" }))
					}
				/>
			</SettingRow>
			<SettingDivider />
			<SettingRow>
				<SettingRowTitle>
					{t("settings.data.s3.secretAccessKey.label")}
				</SettingRowTitle>
				<Input.Password
					...
					style={{ width: 250 }}
					onBlur={() =>
						dispatch(setS3Partial({ secretAccessKey: secretAccessKey || "" }))
					}
				/>
			</SettingRow>
			<SettingDivider />
			...
			<SettingRow>
				<SettingRowTitle>
					{t("settings.data.s3.maxBackups.label")}
				</SettingRowTitle>
				<Selector
					size={14}
					value={maxBackups}
