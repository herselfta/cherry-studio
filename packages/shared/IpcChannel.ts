export enum IpcChannel {
  ...
  App_MacCodeSignatureInfo = 'app:mac-code-signature-info',
  ...
  Backup_BackupMigrationToLocalDir = 'backup:backupMigrationToLocalDir',
  ...
  Backup_BackupMigrationToS3 = 'backup:backupMigrationToS3',
  Backup_RestoreFromS3 = 'backup:restoreFromS3',
  Backup_ListS3Files = 'backup:listS3Files',
  Backup_DeleteS3File = 'backup:deleteS3File',
  Backup_CheckS3Connection = 'backup:checkS3Connection',
  Backup_CreateLanTransferBackup = 'backup:createLanTransferBackup',
  Backup_BackupMigrationToWebdav = 'backup:backupMigrationToWebdav',
  Backup_UploadTextToWebdav = 'backup:uploadTextToWebdav',
  Backup_DownloadTextFromWebdav = 'backup:downloadTextFromWebdav',
